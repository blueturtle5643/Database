...
//Mark columns represent by the string columns[] for this row
                ...
                int state)
{
    ...
    while (columns[i])
    {
        int index = int(columns[i]); //converting array elements containing characters into ascii numbers

        _table[row][index] = state;
